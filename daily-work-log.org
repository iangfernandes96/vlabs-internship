...
** Weekly  Summary
   ...
   + What is my footprint in the realization of the project?
     - AS of now, we have written the documentation for the first phase of the
...
** [2016-06-23 Thu]
    ...
    + What was the task I was assigned today?
     - Today, we had to edit some of the operations in the data-model, to suit
       the changes in requirements.
    + What did I get done against the task?
     - I worked with Sripathi and edited the operations for the Workshop entity,
       and added it to the existing data-model for the outreach portal. 

** [2016-06-24 Fri]

    + What was the task I was assigned today?
     - Today, we had to review the documentation for the outreach portal and
       make the necessary changes.
    + What did I get done against the task?
     - We reviewed the documentation and made the necessary changes. 
** Weekly  Summary
   + What are the insights gained?
     - So far, along with learning how to build a complete end-to-end web
       application, I've also learnt the proper steps involved in the
   ...
   + What is my footprint in the realization of the project?
     - AS of now, we have written the documentation for the second phase of the
       new outreach portal and have begun work on the object implementation of
       the first phase.
...
** [2016-06-29 Wed]
    ...
    + What was the task I was assigned today?
     - Today, we had to work on the object implementation of the second phase,
       and also make a few changes to the datamodel.
    + What did I get done against the task?
     - I reviewed the documentation and made the necessary changes, and started
       work on the object implementation of the second phase. 
** [2016-06-30 Thu]

    + What was the task I was assigned today?
     - Today, I had to continue to work on the object implementation of the second phase.
       
    + What did I get done against the task?
     - I continued to work on the object implementation of the second phase. 

* Month of July
** [2016-07-01 Fri]

    + What was the task I was assigned today?
     - Today, I had to complete work on the object implementation of the second phase
       and start work on the system implementation of the same.
       
    + What did I get done against the task?
     - I completed the object implementation of the second phase and started
       work on the system implementation for the second phase.
...
** Weekly  Summary
   ...
   + What is my footprint in the realization of the project?
     - As of now, we have completed the object and system implementation of the
       data model. 
...
** [2016-07-04 Mon]
    ...
    + What was the task I was assigned today?
     - Today, I had to start implementation of the persistence of the data
       model phase 2. 
       
    + What did I get done against the task?
     - I completed the object and system implementation of the second phase and
       started work on the persistence implementation for the second phase.

** [2016-07-05 Tue]

    + What was the task I was assigned today?
     - Today, we had a meeting to discuss the system API implementation and
       changes to be made in the same.
    + What did I get done against the task?
     - We discussed and decided on a design for the system API, in order to
       facilitate necessary abstraction. I also continued to work on the
       persistence of entities of the second phase of the data model.
** [2016-07-06 Wed]
...
** [2016-07-07 Thu]
    ...
    + What was the task I was assigned today?
     - Today, I had to continue working on the persistence implementation.
    + What did I get done against the task?
     - I continued to work on the implementation of the persistence system.

** [2016-07-08 Fri]

    + What was the task I was assigned today?
     - Today, I had to begin implementing system handlers.
    + What did I get done against the task?
     - I started implementing the necessary system handlers.
** Weekly  Summary
   + What are the insights gained?
     - So far, along with learning how to build a complete end-to-end web
       application, I've also learnt the proper steps involved in the
       completion of the object level as well as persistence implementation 
       of such an application.    
   
   + What is my footprint in the realization of the project?
     - As of now, we have completed the object and system implementation of the
       data model, and are currently working on the persistence implementation
       along with the necessary handlers.

** [2016-07-11 Mon]

    + What was the task I was assigned today?
     - Today, I had to refactor code in the persistence level, so as to
       accommodate some changes made. 
    + What did I get done against the task?
     - I refactored the relevant code and fixed a few erroneous test cases.

** [2016-07-12 Tue]

    + What was the task I was assigned today?
     - Today, I had to a Type entity for artefacts, and make a few changes
       in the implementation of the Workshop entity.
    + What did I get done against the task?
     - I added the Type entity, along with relevant test cases, in both Object
       and Persistence implementation, and modified the Workshop entity.
